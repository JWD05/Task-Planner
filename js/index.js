    ...
    nameCreator.addEventListener('focusout', secondValid);
    taskDescrip.addEventListener('focusout', secondValid);
    assigneeName.addEventListener('focusout', secondValid);
    dueDateInput.addEventListener('focusout', secondValid);
    statusSelect.addEventListener('focusout', secondValid);
